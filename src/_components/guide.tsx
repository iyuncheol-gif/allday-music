...
export default function Guide() {
  return (
    <section className="py-8 md:py-12 bg-white" id="guide">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-3 md:gap-6">
          {usageSteps.map((step, index) => (
            <div key={step.title} className="contents">
              {/* Step Card */}
              <div className="flex-1 w-full bg-white border border-border-light p-3 md:p-4 rounded-xl flex items-center gap-3 md:gap-4 shadow-sm hover:shadow-md transition-all group">
              ...
              {index < usageSteps.length - 1 && (
                <span className="material-symbols-outlined text-gray-300 rotate-90 md:rotate-0 shrink-0 text-lg md:text-xl">
                  arrow_forward
                </span>
              )}
            </div>
